...
This module tests successful operations of CSV loading and analysis tools,
focusing on proper functionality when everything works correctly.

Key concepts:
- Tool success path testing
- Data type detection validation
- Successful CSV to SQLite conversion
- Metadata extraction verification
- Schema operations success

Use cases:
- Testing successful CSV loading and conversion
- Validating proper data type detection
- Ensuring successful statistical calculations
- Testing successful SQL query execution
- Verifying successful schema operations
"""
...
# Week 3 uses MCP tools - we'll test via ChatService
from agents_.chat_service import ChatService


class TestMCPToolsViaService:
    """Test MCP tools via ChatService integration."""
